...
ภารกิจของคุณ:
1. วิเคราะห์ว่าลูกค้าเลือกกล่องประเภทไหน (5 ประเภท):
   - rsc: กล่องมาตรฐาน RSC (ประหยัด แข็งแรง)
   - die_cut: กล่องไดคัท/ฝาเสียบ (โชว์แบรนด์)
   - heart: กล่องหัวใจ (ของขวัญ/เครื่องสำอาง)
   - tube_lock: กล่องทรงยาวแบบ Tube Lock
   - self_lock: กล่องล็อกอัตโนมัติ Self-Lock
2. ยืนยันการเลือกด้วยประโยคสั้นๆ (1 ประโยค)
...
ภารกิจของคุณ:
1. วิเคราะห์ว่าลูกค้าระบุสไตล์ไหม ถ้าไม่ระบุให้ถือว่า "ข้าม"
2. ตอบสั้นๆ 1 ประโยค

นี่เป็น Optional field และไม่มีผลกับการคำนวณราคา ให้ดำเนินการต่อได้ทันที
...
2. ถ้ามี: ยืนยันสั้นๆ แล้วบอกว่า "อัปโหลดไฟล์รูปโลโก้ได้เลย" และถามตำแหน่ง
