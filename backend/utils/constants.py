...
BOX_TYPES = {
    ...
    "tube_lock": {
        "name": "กล่อง Tube Lock",
        "suitable_for": ["non_food", "food_grade", "cosmetic", "general"],
        "production_factor": 1.45,
        "description": "กล่องทรงยาวแบบ Tube Lock เหมาะสินค้าแนวยาว",
        "material_group": "die_cut",
        "has_inner": True,
    },
    "self_lock": {
        "name": "กล่อง Self-Lock",
        "suitable_for": ["general", "non_food", "food_grade", "cosmetic"],
        "production_factor": 1.35,
        "description": "กล่องล็อกอัตโนมัติ แข็งแรง รองรับงานขนส่ง",
        "material_group": "rsc",
        "has_inner": True,
    },
}
