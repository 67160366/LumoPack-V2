...
export default function TubeLockFoldBox({ width = 150, length = 500, depth = 120, foldProgress = 0, panelImages = {}, boxStyle = 'kraft' }) {
  ...
  return (
    <group rotation={[HP, 0, 0]} position={[0, L / 2, 0]}>
      ...
      <group position={[W / 2, 0, 0]} rotation={[0, 0, f.side1]}>
        <group position={[D / 2, 0, 0]}>
          ...
          <group position={[0, 0, -L / 2]} rotation={[f.dustTop, 0, 0]}>
            <group position={[0, 0, -dustH / 2]}>
              <Panel width={D * 0.9} height={dustH} thickness={t} color={cFlap} {...img('side1_dust_top')} />
            </group>
          </group>
        </group>
        ...
        <group position={[D, 0, 0]} rotation={[0, 0, f.face2]}>
          <group position={[W / 2, 0, 0]}>
            <Panel width={W} height={L} thickness={t} color={cMain} {...img('face2')} />

            {/* face2 bottom tuck panel */}
            <group position={[0, 0, L / 2]} rotation={[-f.tuckBot, 0, 0]}>
              <group position={[0, -t, tuckH / 2]}>
                <Panel width={W} height={tuckH} thickness={t} color={cFlap} {...img('face2_tuck_bot')} />
              </group>
              {/* tongue */}
              <group position={[0, 0, tuckH]} rotation={[-f.tongueBot, 0, 0]}>
                <group position={[0, 0, tongueH / 2]}>
                  <Panel width={W * 0.9} height={tongueH} thickness={t} color={cTongue} />
                </group>
              </group>
            </group>
            ...
            <group position={[0, 0, -L / 2]} rotation={[f.tuckTop, 0, 0]}>
              <group position={[0, -t, -tuckH / 2]}>
                <Panel width={W} height={tuckH} thickness={t} color={cFlap} {...img('face2_tuck_top')} />
              </group>
              {/* tongue */}
      ...
      <group position={[-W / 2, 0, 0]} rotation={[0, 0, -f.side2]}>
        <group position={[-D / 2, 0, 0]}>
          <Panel width={D} height={L} thickness={t} color={cMain} {...img('side2')} />

          {/* side2 bottom dust flap */}
          <group position={[0, 0, L / 2]} rotation={[-f.dustBot, 0, 0]}>
            <group position={[0, 0, dustH / 2]}>
              <Panel width={D * 0.9} height={dustH} thickness={t} color={cFlap} {...img('side2_dust_bot')} />
            </group>
          </group>
          ...
          <group position={[0, 0, -L / 2]} rotation={[f.dustTop, 0, 0]}>
            <group position={[0, 0, -dustH / 2]}>
              <Panel width={D * 0.9} height={dustH} thickness={t} color={cFlap} {...img('side2_dust_top')} />
            </group>
          </group>
        </group>
      </group>
